...
a mixture of gases as a single [`composite_species`](@ref vitiated). This package uses parametric typing to make it compatible with forward-mode differentiation.
